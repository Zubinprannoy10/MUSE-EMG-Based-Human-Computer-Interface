...
class Recorder(object):
    def __init__(self, debug=False, display=True, num_channels=None):
        # make audio stream

        self.audio_stream = sd.InputStream(device=10, channels=1, samplerate=16000)
...
if __name__ == '__main__':
    with Recorder(debug=False, num_channels=1) as r:
        while True:
            r.update()
